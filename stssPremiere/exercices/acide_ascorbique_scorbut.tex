\exercice{L'acide ascorbique}\points{9}
...
\medskip
\textbf{Données : }
\textit{Masse molaire atomique :}

$M(H) = \qty{1} {\g\per\mole}$, $M(C) = \qty{12} {\g\per\mole}$, $M(N) = \qty{14} {\g\per\mole}$, $M(O)=\qty{16} {\g\per\mole}$

%\textit{ $\qty{1} {g} = \qty{1 000} {mg}$   ;  $\qty{1} {L} = \qty{1 000} {\ml}$ }

\bigskip
\question{
  Quelle espèce chimique permet de lutter contre le scorbut ? Dans quels aliments peut-on la trouver ?\points{2}
}{
  C'est la vitamine C qui permet de lutter contre le scorbut, qu'on trouve dans les fruits et légumes frais. \points{2}
}

La concentration massique en vitamine C dissout dans un jus de \variationSujet{pomme}{poire} est $C_m = \variationSujet{\qty{9,0e-3}{\g\per\litre}}{\qty{6.0e-3}{\g\per\litre}}$.

\question{
  Quel est le soluté ? Quelle est la solution ?    \points{1}
}{
  Le soluté est la vitamine C, la solution est le jus de \variationSujet{pomme}{poire}.\points{1}
}

\question{
  Calculer la masse de vitamine C présente dans une bouteille de volume $V = \variationSujet{\qty{1,5} {\litre}}{\qty{2.0}{\litre}}$ de jus de \variationSujet{pomme}{poire}. \points{1,5}
}{
  \begin{equation*}
...
\question{
  Déterminer la quantité de matière en vitamine C présent dans un volume de $\variationSujet{\qty{1,5} {\litre}}{\qty{2.0}{\litre}}$ de jus de \variationSujet{pomme}{poire}.  \points{1,5}
}{
  \begin{equation*}
...
\question{
  En déduire la concentration molaire en vitamine C dans le jus de \variationSujet{pomme}{poire}.                                \points{1,5}
}{
  \begin{equation*}
    c = \dfrac{n}{V}
