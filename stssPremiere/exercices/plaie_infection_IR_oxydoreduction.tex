...
\exercice{Détecter une infection et soigner une plaie infectée}
...
%%%% Partie I
\titreSousSection{Contrôler la température}\points{8}
...
%%%% Partie II
\titreSousSection{Désinfecter la plaie}\points{12}
...
\question{
  ...
  Rappeler la différence d'utilisation entre les deux.
}{
...
\question{
  En vous aidant de la réaction d'oxydoréduction et du document~\ref{doc:E2_action_betadine}, expliquer comment le diiode tue les micro-organismes.
}{
