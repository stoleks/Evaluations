...
\question{
  ...
  Quand le muscle ciliaire se contracte, le cristallin s'arrondit et devient plus convergent.
}[2]

\question{
  Expliquer pourquoi la cyclopégie entraine l'arrêt du phénomène d'accommodation.
}{
  La cyclopégie paralyse les muscles ciliaires, qui ne peuvent plus modifier la forme du cristallin.
}[3]

\question{
  Expliquer pourquoi la cylopégie est nécessaire pour prescrire une correction optique totale adaptée à l’œil.
}{
  Si les muscles ciliaires ne sont pas paralysés, le cerveau va les utiliser pour modifier le cristallin pour voir le plus net possible (accomodation), ce qui va fausser les prescriptions.
}[3]

\question{
  Indiquer en justifiant si les verres que porteront Malala seront convergents ou divergents.
}{
  Il seront \variationSujet{divergents}{convergents}, car ils sont plus épais \variationSujet{sur les côtés}{au centre} et ils ont une vergence \variationSujet {négative}{positive.}
}[2]