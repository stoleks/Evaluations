...
\newpage
\vspace*{-50pt}
\exercice{Automatismes (connaitre son cours) (24 minutes)}
\medskip
...
%%%%
\vspace{24pt}
\exercice{L'acide ascorbique (33 minutes)}
...
\question{
  ...
  Le soluté est la vitamine C, la solution est le jus de pomme.\points{1,5}
}{0}
...
\question{
  La formule brute de la vitamine C est \chemfig{C_6H_8O_6}. Calculer la masse molaire moléculaire de la vitamine C.
}{
  \begin{equation*}
...
\question{
  ...
  A-t-elle un taux de vitamine C suffisant pour être en bonne santé ?b
}{
...
%%%%
\vspace{24pt}
\exercice{L'acidification des océans (29 minutes)}
...
%%%%
\bigskip
\exercice{Traitement des eaux (19 minutes)}
...
\question{
  ...
  Citer une méthode rapide permettant de le vérifier expérimentalement.
}{
...
\begin{boite}
  ...
  \separationBlocs{
    ...
    \centering
    \image{0.3}{images/picto_nocif}
    \image{0.3}{images/picto_corrosif}
  }{
...
\question{
  Rappeler la signification des pictogrammes de sécurités présent sur l'étiquette de l'acide chlorhydrique.
}{
...
\question{
  Écrire l'équation acido-basique ajustée de la réaction de neutralisation de l'eau de lavage. 
}{
  \begin{equation*}
