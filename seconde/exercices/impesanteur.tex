...
\begin{doc}{Station spatiale internationale (ISS)}
  ...
  On s'intéresse à la station spatiale internationale, notée ISS, en orbite circulaire autour de la Terre à une hauteur $h$ et une distance $d$ du centre de la Terre.
...
%%
\begin{doc}{Force centrigure}%d'inertie d'entraînement}
