\exercice{Conduite et alcoolémie}\points{10}
...
Pour un volume $V_\text{éth}$ d'éthanol, on peut calculer la masse d'éthanol avec la relation suivante 
...
En France, « \textit{il est interdit de conduire avec un taux d'alcool dans le sang supérieur ou égal à \qty{0,5}{\g\per\litre} de sang} ».
...
\question{
  Calculer de nouveau la concentration massique dans le sang de \variationSujet{Sihame}{Nassim} en tenant compte de cette information.\competence{APP, REA}
}{
...
\question{
  ...
  Comme la concentration massique est supérieure à la concentration maximale autorisée, il est donc toujours interdit de conduire.
  \points{2.5}
}