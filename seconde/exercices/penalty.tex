...
\question{
  ...
  On étudie le mouvement du ballon de football, dans le référentiel terrestre.
}
...
\question{
  ...
  Oui, car le ballon est immobile, donc les forces doivent se compenser.
}
...
\question{
  ...
  Non, car les forces ne se compensent pas, donc le ballon n'a pas un mouvement rectiligne uniforme.
}
