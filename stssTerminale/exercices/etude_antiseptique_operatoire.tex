...
\question{
  ...
  Avec le graphique, on trouve une concentration de \qty{0.0045}{\mol\per\litre}.
}
...
\question{
  ...
  Pour convertir, on multiplie la concentration molaire par la masse molaire
  \begin{equation*}
    c_m(I_2) = C(I_2) M_{I_2} 
    = \qty{0,004}{\mol\per\litre} \times \qty{253,8}{\g\per\mole} 
    = \qty{1,02}{\g\per\litre}
  \end{equation*}
}
...
\qty{10}{\percent}.
  ...
  Comme on a dilué dix fois, il faut multiplier par dix la concentration, donc \qty{10,2}{\g\per\litre}.
}
