...
\begin{doc}{Le glucose}[\label{doc:BAC_glucose}]
...
\begin{doc}{La stévia}[\label{doc:BAC_stevia}]
...
solution aqueuse.
  ...
  Le glucose est soluble dans le sang, car sa molécule comporte de nombreux groupe hydroxyle polaire, qui vont pouvoir former des liaisons hydrogène avec les molécules d'eau. \points{1}
}
