...
Les noyaux d'iode 125 (symbole \isotope{I}{53}{125}) sont radioactifs, ils émettent des particules de faible énergie et un rayonnement électromagnétique de longueur d'onde 
$\lambda_0 = \qty{0,034}{\nm}$.
...
\question{
  À l'aide d'une construction graphique réalisée sur la courbe suivante (à rendre avec la copie de chimie), montrer que la période radioactive de l'iode 125 est voisine de 60 jours.
}{}
...
%\begin{doc}{Domaines spectraux des ondes électromagnétiques}[\label{doc:BB2_domaines}]
 % \begin{center}
