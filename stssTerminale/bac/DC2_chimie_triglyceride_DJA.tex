...
%%
\medskip
Une célèbre marque de pâte à tartiner contient \qty{1,23}{\mg} de Manganèse pour \qty{100}{\g} de pâte à tartiner.

\question{
  Donner le nom complet et la définition de la DJA.
}{
  La DJA est la Dose Journalière Admissible. C'est la quantité maximale de l'espèce que l'on peut manger tous les jours sans risques pour la santé. \points{2}
}{0}

\question{
  Calculer la dose maximale de manganèse que peut ingérer un-e enfant de \qty{40}{\kg} par jour.
}{
  La dose maximale vaut 
  \begin{equation*}
    \qty{40}{\kg} \times \qty{0,06}{\mg\per\kg} = \qty{2,4}{\mg} \points{2}
  \end{equation*}
}{0}

\question{
  Calculer la masse maximale de pâte à tartiner que peut manger un-e enfant de \qty{40}{\kg} en respectant cette dose toxicologique.
}{
  On raisonne encore sur les unités pour avoir une grandeur en \unit{\g}
  \begin{equation*}
    \qty{2,4}{\mg} \times \dfrac{\qty{100}{\g}}{\qty{1,23}{\mg}} = \qty{195}{\g} \points{2}
  \end{equation*}

  On peut remarquer que ce n'est pas possible de respecter l'apport recommandé en oméga-3 sans s'intoxiquer avec du manganèse.
}{0}